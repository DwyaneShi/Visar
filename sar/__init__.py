...
"""Device usage part of SAR file"""
PART_DEV = 6

"""CPU regexp pattern for detecting SAR section header.
Compatible with log generated by command sar -P ALL"""
...
Compatible with log generated by command sar -r"""
...
Compatible with log generated by command sar -S"""
FIELD_PAIRS_SWP = {
...
Compatible with log generated by command sar -b"""
PATTERN_IO = ".*tps.*rtps.*wtps.*bread\/s.*bwrtn\/s.*"

"""Regexp terms for finding fields in SAR parts for io usage"""
FIELDS_IO = [
    '^tps', '^rtps', '^wtps', 'bread\/s', 'bwrtn\/s'
]

"""Pair regexp terms with field names in io usage output dictionary"""
FIELD_PAIRS_IO = {
...
"""Device usage regexp pattern for detecting SAR section heade.
Compatible with log generated by command sar -d -p"""
PATTERN_DEV = ".*DEV.*tps.*rd_sec\/s.*wr_sec\/s.*await.*svctm.*util.*"

"""Regexp terms for finding fields in SAR parts for device usage"""
FIELDS_DEV = [
    '^DEV', '^tps', 'rd_sec\/s', 'wr_sec\/s', 'await', 'svctm', '\%util'
]

"""Pair regexp terms with field names in device usage output dictionary"""
FIELD_PAIRS_DEV = {
    'DEV': FIELDS_DEV[0], 'tps': FIELDS_DEV[1], 'rd_sec': FIELDS_DEV[2],
    'wr_sec': FIELDS_DEV[3], 'await': FIELDS_DEV[4], 'svctm': FIELDS_DEV[5],
    'util': FIELDS_DEV[6]
}
...
Compatible with log generated by command sar -n DEV"""
...
__all__ = [
    ...
    "PATTERN_CPU", "PATTERN_MEM", "PATTERN_SWP", "PATTERN_IO", "PATTERN_DEV",
    "PATTERN_NET", "PATTERN_PAGING", "PATTERN_HOSTNAME",
